...
\section{Display}
  ...
  \begin{figure}[b]
  \begin{subfigs}
    \jpgfigure[150]{Wood Sorrel and Chrysanthemum Box}{box}{1650\sRijksB{}}
    \subfigure[150]{One and Rhombus}{noren}{1600\sRijks{}}
  \end{subfigs}
  \end{figure}
...
\clearpage
  ...
  \subfigure{Iroha Banner}{iroha}{\sOUmajirushi{110}}
...
\section{Variation}
  ...
  gentian-like plants as his mon (\emph{figure \ref{twoplants}}).\sSamuraiSourcebook{73.14} (See also \emph{figure \ref{luck-circles}}.)
...
\section{Japanese Heraldry Beyond Banners}
